...
// รับค่า room_name จาก JSON payload หรือ GET parameter
...
// รับค่า userID จาก JSON payload หรือ GET parameter
...
// รับ mode จาก payload (guest หรือ login), ค่า default "login"
$mode = isset($data['mode']) ? $data['mode'] : 'login';

include '../config/db.php';

// ดึงข้อมูลห้องจากตาราง rooms โดยใช้ room_name
...
// หากไม่ใช่ guest mode ให้ตรวจสอบผู้ใช้ในตาราง users
if ($mode !== 'guest') {
